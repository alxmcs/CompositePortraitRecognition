...
from get_embeddings_for_TDCS import get_distances
...
if __name__ == "__main__":
    ...
    for i in range(1, size):
        ...
        try:
            ...
            wrong_distances_arc = get_distances(portrait_image_with_style_wrong_embed_arc,
                                                random_sketch_image_embed_arc)
            ...
            path_to_save_right = os.path.join("..", "TDCS", f"for_tf_with_st/{folder_name}", "right",
                                              f"tf_embed_{count_to_save}")
            path_to_save_right_distances = os.path.join("..", "TDCS", f"for_tf_with_st/{folder_name}", "right",
                                                        f"tf_embed_distances_{count_to_save}")
            path_to_save_wrong = os.path.join("..", "TDCS", f"for_tf_with_st/{folder_name}", "wrong",
                                              f"tf_embed_{count_to_save}")
            path_to_save_wrong_distances = os.path.join("..", "TDCS", f"for_tf_with_st/{folder_name}", "wrong",
                                                        f"tf_embed_distances_{count_to_save}")
            ...
            # arc
            path_to_save_right = os.path.join("..", "TDCS", f"for_arc_with_st/{folder_name}", "right",
                                              f"arc_embed_{count_to_save}")
            path_to_save_right_distances = os.path.join("..", "TDCS", f"for_arc_with_st/{folder_name}", "right",
                                                        f"arc_embed_distances_{count_to_save}")
            path_to_save_wrong = os.path.join("..", "TDCS", f"for_arc_with_st/{folder_name}", "wrong",
                                              f"arc_embed_{count_to_save}")
            path_to_save_wrong_distances = os.path.join("..", "TDCS", f"for_arc_with_st/{folder_name}", "wrong",
                                                        f"arc_embed_distances_{count_to_save}")
